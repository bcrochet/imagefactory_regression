...
#        Regression test for Image Factory #bug782542
#        Created by bcrochet (brad@redhat.com)
#        Date: 17/01/2012
#        Issue: Oz should create screenshot dir if it doesn't exist and has perms
#
# return values:
# 0 - OK: everything OK
...
def bodyTest():
    ...
    cmdline = "imagefactory --warehouse  http://localhost:9090/ --image_bucket images --build_bucket builds --target_bucket target_images --template_bucket templates --icicle_bucket icicles --provider_bucket provider_images --imgdir /var/lib/imagefactory/images --template templates/bug782542.tdl --target rhevm"
